...
typedef struct
{
    unsigned char       MonImage[200][160];           // 32000 car 2 pixel par octed -> 320/2*200 = 32000
    ...
    unsigned short int  Couleur_Palette_0[16];        // une seule palette de 16 couleurs sur 2 octed A=0 R=x G=x B=x
    unsigned char       Couleur_Palette_1a15[15 * 32];  // les autres 15 palettes restantes... 32 octed * 15
} FormatPIC;
